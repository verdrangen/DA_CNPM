...
namespace DA_CNPM.ENTITY
{
    ...
    public partial class DOAN_CNPMEntities : DbContext
    {
        ...
        public virtual int USP_GetAccountDetailList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_GetAccountDetailList");
        }
    
        public virtual int USP_GetAccountList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_GetAccountList");
        }
        ...
        public virtual int USP_GetAccountByUserName(string userName)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("userName", userName) :
                new ObjectParameter("userName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_GetAccountByUserName", userNameParameter);
        }
        ...
        public virtual int USP_UPDATE_ACCOUNT(string user_name, string password, string group_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_UPDATE_ACCOUNT", user_nameParameter, passwordParameter, group_idParameter);
        }
